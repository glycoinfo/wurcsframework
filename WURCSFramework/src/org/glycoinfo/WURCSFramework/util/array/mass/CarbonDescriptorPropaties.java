...
//	SZ3_HYDROXYL_U ( 'H', true, 1, 3 ), // -C(H)(H)(X) "CH2OH"
	SZ3_ACETAL_L   ( 'c', true, 2, 3 ), // -C(X)(X)(H) "CH(OH)2"
	SZ3_ACETAL_U   ( 'C', true, 3, 3 ), // -C(X)(X)(X) "C(OH)3"
...
//	SZ3_NORING_X_U ( 'Q', true, 3, 3 ), // -C(X)(Y)(Z) "C(OH)3"
	SZ2_ALDEHYDE_L ( 'o', true, 1, 1 ), // -C(=X)(H) "COH"
//	SZ2_ACID_L     ( 'a', true, 2, 1 ), // -C(=O)(O) "COOH"
	SZ2_ANOMER     ( 'a', true, 2, 3 ), // -C(X)(Y)(H) "CH(OH)2"
	SZ2_ALDEHYDE_U ( 'O', true, 1, 2 ), // -C(=X)(H) "CHOH"
	SZ2_ACID_U     ( 'A', true, 2, 1 ), // -C(=X)(Y) "COOH"
	...
	DZ2_CISTRANS_EU( 'E', true, 2, 2 ), // =C(X)(Y) "C(OH)2"
	DZ2_CISTRANS_ZU( 'Z', true, 2, 2 ), // =C(X)(Y) "C(OH)2"
	DZ2_CISTRANS_XU( 'F', true, 2, 2 ), // =C(X)(Y) "C(OH)2"
	SZ1_XETHYNE    ( 'T', true, 1, 1 ), // -C(#X) "COH"
//	DZ1_KETENE_L   ( 'k', true, 1, 0 ), // =C(=O) "CO"
	DZ1_KETENE_U   ( 'K', true, 1, 0 ), // =C(=X) "CO"
...
//	SS3_XMETHYNE   ( 'D', false, 2, 2 ), // -C(X)(X)- "C(OH)2"
	SS3_ACETAL     ( 'C', false, 2, 2 ), // -C(X)(X)- "C(OH)2"
	...
	SS3_ANOMER     ( 'a', false, 2, 2 ), // -C(X)(X)- "C(OH)2"
//	SS2_KETONE_L   ( 'o', false, 1, 0 ), // -C(=O)- "CO"
//	SS2_KETONE_U   ( 'O', false, 1, 1 ), // -C(=X)- "COH"
	SS2_KETONE_U   ( 'O', false, 1, 0 ), // -C(=X)- "CO"
	SS2_UNDEFINED_U( 'U', false, 1, 0 ), // -C(=X)- "CO"
	...
	/** Get BigDecimal of default mass for the descriptor */
	...
	public int getMaxSignificantDigit() {
		if ( this.m_iNumberOfHydrogen > 0 && this.m_iNumberOfOxygen > 0 ) {
			...
			int t_iSignificantDigitO = AtomicProperties.O.getMassPrecision();
			return (t_iSignificantDigitH > t_iSignificantDigitO)? t_iSignificantDigitH : t_iSignificantDigitO;
		}

		if ( this.m_iNumberOfHydrogen > 0 ) return AtomicProperties.H.getMassPrecision();
		if ( this.m_iNumberOfOxygen   > 0 ) return AtomicProperties.O.getMassPrecision();
