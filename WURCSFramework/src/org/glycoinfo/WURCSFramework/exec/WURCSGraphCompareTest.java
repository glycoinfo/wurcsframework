...
public class WURCSGraphCompareTest {
...
//		String t_strWURCSFile = "test_stream_compare.txt";
		String t_strWURCSFile = "all_wurcs181113h_graph.txt";
...
//		String output = t_strDir + "graph_test_out.txt";
		String output = t_strDir + "all_wurcs181113h_graph_out.txt";
//		String output = t_strDir + "test_stream_compare_graph_out.txt";
		...
		try {
			t_mapWURCSIndex = readWURCS2(new BufferedReader(new FileReader(input)));
...
//			LinkedList<WURCSGraph> t_objListGraph =new LinkedList<WURCSGraph>();
//			LinkedList<WURCSGraphToArray> t_objListGraphToArray =new LinkedList<WURCSGraphToArray>();
...
//					pw.println("WURCSin:  "+t_strOrigWURCS);
//					System.out.println("WURCSin:  "+t_strOrigWURCS);
...
//					System.err.print(m1modedlk.getModificationPosition()+" "+m2modedlk.getModificationPosition()+"|");
					...
					if(m1modedlk.getModificationPosition()!=m2modedlk.getModificationPosition()){System.err.print("differnet Modification Position");return equiv;}
					}
				}
			}
...
//					System.err.print(m1modaltedlk.getModificationPosition()+" "+m2modaltedlk.getModificationPosition()+"|");
					...
					if(m1modaltedlk.getModificationPosition()!=m2modaltedlk.getModificationPosition()){System.err.print("differnet Modification Position");return equiv;}
					}
				}
			}
		equiv=true;
