...
public class WURCSGraphCompareTest_WURCSver {
...
//		String output = t_strDir + "graph_test_WURCS_out.txt";
		String output = t_strDir + "all_wurcs181113h_graph_wurcsver_out.txt";
...
//standardization of two WURCS ( in and out )
				...
				equiv=inWURCS.get(key).compareTo(outWURCS.get(key));
				System.err.println("backbones: "+ key+": \n");
				pw.print(key+": ");
				if(equiv!=0) {
