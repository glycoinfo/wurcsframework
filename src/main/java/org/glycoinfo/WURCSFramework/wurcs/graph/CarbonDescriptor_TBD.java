 ...
 *
 */
public enum CarbonDescriptor_TBD {
...
//	SZ3_NORING_X_U ( 'Q', "sp3", 1,0, 3,  "X", false,"-X", "-X", "-X", 10 ), // -C(X)(Y)(Z) ver 2.0a change (from 'R')
	SZ3_STEREO_S_L ( '1', "sp3", 1,0, 3,  "S", null, "-X", "-X", "-H", 20 ), // -C(X)(Y)(H) ver 2.0b change (no check anomer)
	SZ3_STEREO_R_L ( '2', "sp3", 1,0, 3,  "R", null, "-X", "-X", "-H", 19 ), // -C(X)(Y)(H) ver 2.0b change (no check anomer)
	SZ3_STEREO_s_L ( '3', "sp3", 1,0, 3,  "s", null, "-X", "-X", "-H", 20 ), // -C(X)(Y)(H) ver 2.0b change (no check anomer)
	SZ3_STEREO_r_L ( '4', "sp3", 1,0, 3,  "r", null, "-X", "-X", "-H", 19 ), // -C(X)(Y)(H) ver 2.0b change (no check anomer)
	SZ3_STEREO_X_L ( 'x', "sp3", 1,0, 3,  "X", null, "-X", "-X", "-H", 18 ), // -C(X)(Y)(H) ver 2.0b change (no check anomer)
	SZ3_STEREO_S_U ( '5', "sp3", 1,0, 3,  "S", null, "-X", "-X", "-X", 23 ), // -C(X)(Y)(Z) ver 2.0b change (no check anomer)
	SZ3_STEREO_R_U ( '6', "sp3", 1,0, 3,  "R", null, "-X", "-X", "-X", 22 ), // -C(X)(Y)(Z) ver 2.0b change (no check anomer)
	SZ3_STEREO_s_U ( '7', "sp3", 1,0, 3,  "s", null, "-X", "-X", "-X", 23 ), // -C(X)(Y)(Z) ver 2.0b change (no check anomer)
	SZ3_STEREO_r_U ( '8', "sp3", 1,0, 3,  "r", null, "-X", "-X", "-X", 22 ), // -C(X)(Y)(Z) ver 2.0b change (no check anomer)
	SZ3_STEREO_X_U ( 'X', "sp3", 1,0, 3,  "X", null, "-X", "-X", "-X", 21 ), // -C(X)(Y)(Z) ver 2.0b change (no check anomer)
...
//	DZ2_CISTRANS_NU( 'P', "sp2", 2,0, 2,  "N", null, "-X", "-X", null,  8 ), // =C(X)(Y) ver 2.0a new (impossible configuration)
	...
	// Ambiguous
	SZX_UNDEF_L    ( 'u',  "?" , 1,0, 0, null, null, "-X", "-H", null, 15 ), // -C(X)(Y)(H) or -C(=O)(H) ver 2.0a new ('x' and 'O')
	SZX_UNDEF_U    ( 'U',  "?" , 1,0, 0, null, null, "-X", "-X", null, 16 ), // -C(X)(Y)(Z) or -C(=X)(X) ver 2.0a new ('X' and 'A')
...
//	SS2_KETONE_L   ( 'o', "sp2", 1,1, 1, null, null, "=O", null, null, 16 ), // -C(=O)- ver 2.0a change (from 'k')      anomer
	...
	// Ambiguous
	SSX_UNDEF_U    ( 'U',  "?" , 1,1, 0, null, null, "-X", null, null, 15 ), // -C(X)(Y)- or -C(=X)- ver 2.0a new ('X' and 'O')
