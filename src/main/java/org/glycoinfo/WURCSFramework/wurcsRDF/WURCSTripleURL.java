...
public enum WURCSTripleURL{
	...
	GLYAN()		{ public String get(String ac_no, Object val)	{ return GLYCAN.BASE_URL+"/"+ac_no ;}},
	//	http://rdf.glycoinfo.org/glycan/G00012MO/wurcs/2.0
	GLY_WURCS()	{ public String get(String ac_no, Object val)	{ return GLYCAN.BASE_URL+"/"+ac_no+WURCS.VERSION ;}},
...
//	GLIP()		{ public String get(String ac_no, Object val)	{ return GLYCAN.BASE_URL+"/"+ac_no+WURCS.VERSION+"/GLIP/"+objectToString(val) ;}},
...
//	GLIPS()		{ public String get(String ac_no, Object val)	{ return GLYCAN.BASE_URL+"/"+ac_no+WURCS.VERSION+"/GLIPS/"+objectToString(val) ;}},
...
//	LIN()		{ public String get(String ac_no, Object val)	{ return GLYCAN.BASE_URL+"/"+ac_no+WURCS.VERSION+"/LIN/"+objectToString(val) ;}},
...
//	RES()		{ public String get(String ac_no, Object val)	{ return GLYCAN.BASE_URL+"/"+ac_no+WURCS.VERSION+"/RES/"+objectToString(val) ;}},
